...
// Impor card
import 'package:zyramarket/widgets/product_card.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  final List<ItemHomepage> items = [
    ItemHomepage("Lihat Daftar Product", Icons.loyalty_rounded,Colors.brown.shade200),
    ItemHomepage("Tambah Product", Icons.hotel_class_rounded, Colors.blueGrey.shade200),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.blueAccent.shade700, // warna header
